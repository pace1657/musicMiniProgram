...
__DEFINE__(1664807715414, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1664807715415,"./event-store":1664807715416}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664807715415, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1664807715416, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1664807715415,"./utils":1664807715417}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664807715417, function(require, module, exports) {
...
return __REQUIRE__(1664807715414);
})()
